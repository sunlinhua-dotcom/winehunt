...
def build_pdf(output_path):
    ...
    story.append(Paragraph("各产区运费 (USD/瓶)", S_H2))
    story.append(make_table(
        ["产区", "整箱", "散瓶", "备注"],
        [
            ["波尔多 / 勃艮第 / 罗纳河谷", "$7", "$12", "欧洲 → 香港"],
            ["意大利 / 香槟 / 西班牙",     "$7", "$12", "欧洲 → 香港"],
            ["美国 (加州)",               "$20", "$25", "跨太平洋运输"],
            ["澳大利亚",                  "$20", "$25", "南半球运输"],
            ["智利",                      "$18", "$23", "南美运输"],
        ],
    ...
    story.append(make_table(
        ...
        [
            ...
            ["价格合理性", "2 分", "$50-$5000 → 2 / >$5000 → 1 / <$50 → 0"],
            ["差价绝对值", "1 分", "卖出价 − 买入价 > $100 → 加 1 分"],
        ],
    ...
    story.append(make_table(
        ...
        [
            ...
            ["汇率波动",  "系统以 USD 统一计价，实际支付时需考虑汇率变动"],
